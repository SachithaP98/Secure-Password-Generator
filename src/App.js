  ...
  return (
    <div className="App">
      ...
      <div className="generator">
        <h1 className="generator__title">Secure Password Generator</h1>
        <h4 className="password">{password}</h4><br />
        ...
        <form className="generator__form">
          <div className="generator__form-controls">
            ...
            <div className="generator__length">
              ...
              <div className="generator__length-counter"><br />
        ...
        <h4 className="generator__footer">IT20170448 (IE3042 – SSS)</h4>
      </div>
    </div>
  );
}
